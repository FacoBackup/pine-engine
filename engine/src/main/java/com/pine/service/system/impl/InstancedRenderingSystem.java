...
//
//    @PInject
//    public InstancedSceneComponent instancedMeshes;
//
//    @PInject
...
//        baseModelMatrix = coreResourceRepository.demoShader.addUniformDeclaration("baseModelMatrix", GLSLType.MAT_4);
//    }
//
//    @Override
...
//    }
//
//    private void generateBuffers(InstancedSceneComponent component) {
...
//            component.allocation = new InstancedSceneComponent.AllocationDTO(buffer, instanceVBO, component.numberOfInstances);
//        }
//    }
//
//    private static FloatBuffer buildBuffer(InstancedSceneComponent component) {
...
//    }
//
//    private static void buildTransformationList(InstancedSceneComponent component) {
...
//                var transform = new InstancedSceneComponent.TransformationDTO();
