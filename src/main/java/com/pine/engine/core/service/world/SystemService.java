...
import com.pine.engine.core.system.*;
...
public class SystemService extends SerializableRepository implements Updatable, Renderable {
...
//        engine.getModules().stream().map(m -> m.getSystems())
    ...
    private void initializeSystem(ISystem system){
        // TODO - ONLY ENGINE INSTANTIATED CLASSES
